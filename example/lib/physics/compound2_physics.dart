...
class Compound2Physics extends StatefulWidget {
  const Compound2Physics({
    Key? key,
  ...
  @override
  _Compound2PhysicsPageState createState() => _Compound2PhysicsPageState();
}

class _Compound2PhysicsPageState extends State<Compound2Physics> {
