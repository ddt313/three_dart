...
class CompoundPhysics extends StatefulWidget {
  const CompoundPhysics({
    Key? key,
  ...
  @override
  _CompoundPhysicsPageState createState() => _CompoundPhysicsPageState();
}

class _CompoundPhysicsPageState extends State<CompoundPhysics> {
