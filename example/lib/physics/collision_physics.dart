...
class CollisionPhysics extends StatefulWidget {
  ...
  @override
  _CollisionPhysicsPageState createState() => _CollisionPhysicsPageState();
}

class _CollisionPhysicsPageState extends State<CollisionPhysics> {
