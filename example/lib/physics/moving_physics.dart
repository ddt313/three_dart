...
class MovingPhysics extends StatefulWidget {
  const MovingPhysics({
    Key? key,
  ...
  @override
  _MovingPhysicsPageState createState() => _MovingPhysicsPageState();
}

class _MovingPhysicsPageState extends State<MovingPhysics> {
